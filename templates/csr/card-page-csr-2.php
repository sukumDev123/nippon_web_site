...
<div class="card-page">
            ...
            <div class="col-12 col-lg-7">
                ...
                <div class="col-12 col-lg-5">
                    ...
                    <?php if($args["video_link"]): ?>
                    <iframe class="mobile"  height="400" src="<?php echo $args["video_link"] ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <?php endif; ?>
                    <p class="detail"><?php echo $args["detail"] ?></p>
                    <a class="btn-link-csr window"  target="_blank" href="<?php echo $args["btn-link-csr"] ?>">
        ...
        <a class="btn-link-csr mobile"  target="_blank" href="<?php echo $args["btn-link-csr"] ?>">
                        <button><?php echo $args["btn-title-csr"] ?></button>
                    </a>